...
from apps.licenses.models import LicenseStatus
...
class TestLicenseKeyEndpoints:
    ...
    def test_create_license_key(self, api_client, brand, brand_auth_headers):
        ...
        response = api_client.post(
            ...
            data={"customer_email": "newuser@example.com", "customer_name": "New User"},
            format="json",
            **brand_auth_headers,
        )
    ...
    def test_list_license_keys(self, api_client, license_key, brand_auth_headers):
        ...
        response = api_client.get("/api/v1/brand/license-keys/", **brand_auth_headers)
    ...
    def test_get_license_key_detail(self, api_client, license_key, brand_auth_headers):
        ...
        response = api_client.get(
            f"/api/v1/brand/license-keys/{license_key.key}/", **brand_auth_headers
        )
...
class TestLicenseEndpoints:
    ...
    def test_create_license(self, api_client, license_key, product, brand_auth_headers):
        ...
        response = api_client.post(
            ...
            data={"product_id": str(product.id), "seat_limit": 5},
            format="json",
            **brand_auth_headers,
        )
    ...
    def test_create_license_invalid_product(
        self, api_client, license_key, brand_auth_headers
    ):
    ...
    def test_suspend_license(self, api_client, license, brand_auth_headers):
        ...
        response = api_client.post(
            f"/api/v1/brand/licenses/{license.id}/suspend/", **brand_auth_headers
        )
    ...
    def test_resume_license(self, api_client, license, brand_auth_headers):
        ...
        response = api_client.post(
            f"/api/v1/brand/licenses/{license.id}/resume/", **brand_auth_headers
        )
    ...
    def test_cancel_license(self, api_client, license, brand_auth_headers):
        ...
        response = api_client.post(
            f"/api/v1/brand/licenses/{license.id}/cancel/", **brand_auth_headers
        )
